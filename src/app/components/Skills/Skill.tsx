    ...
    return (
        <div className="group relative flex cursor-pointer">
            <motion.img
                ...
                src={imageURL}
                className="rounded-full border border-[#bee7d3/10]  object-cover w-24 h-24 xs:w-16 xs:h-16 xl:w-24 xl:h-24 filter group-hover:grayscale transition duration-300 ease-in-out relative z-10"
            />
